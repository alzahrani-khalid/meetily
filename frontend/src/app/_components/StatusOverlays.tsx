...
function StatusOverlay({ show, message, sidebarCollapsed }: StatusOverlayProps) {
  ...
  return (
    <div className="fixed bottom-4 start-0 end-0 z-10">
      <div
        className="flex justify-center ps-8 transition-[margin] duration-300"
        style={{
          marginInlineStart: sidebarCollapsed ? '4rem' : '16rem'
        }}
      >
        <div className="w-2/3 max-w-[750px] flex justify-center">
          <div className="bg-white rounded-lg shadow-lg px-4 py-2 flex items-center space-x-2 rtl:space-x-reverse">
